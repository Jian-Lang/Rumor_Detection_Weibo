...
class Model(torch.nn.Module):
    ...
    def __init__(self, input_size):
        ...
        lstm_hidden_size = 1 + 23 + 1 + 1 + 15 + 1
        ...
        self.norm = torch.nn.BatchNorm1d(20 + 1 + 15 + 1)
        self.linear = torch.nn.Linear(1 + 23 + 1 + 1 + 15 + 1, 1)
    ...
    def forward(self, text_embedding, verified, description, gender, messages, followers,
                ...
                negative_max, neutral_max, positive_original, negative_original, neutral_original,word_rumor_score_base
                ):
        ...
        norm_input = torch.cat([text_embedding, messages, followers,
                                ...
                                time_interval, emb, comment_embedding,emotion,word_rumor_score_base
                                ], dim=1)
